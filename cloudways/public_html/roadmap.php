...
<style>
body{font-family:Arial,sans-serif;background:#f5f7fb;color:#111827;margin:0;padding:28px}.wrap{max-width:980px;margin:auto}.card,.phase{background:#fff;padding:24px;border-radius:18px;box-shadow:0 8px 30px rgba(0,0,0,.08);margin-bottom:18px}.top{margin-bottom:18px}.small{font-size:14px;color:#64748b;line-height:1.5}.phaseHead{display:flex;justify-content:space-between;gap:12px;align-items:center}.badge{background:#eef2ff;color:#3730a3;border-radius:999px;padding:7px 11px;font-weight:bold;font-size:13px}.state{background:#f8fafc;border:1px solid #cbd5e1;border-radius:999px;padding:7px 11px;font-weight:bold;font-size:13px}.phase ul{margin:12px 0 0 22px;padding:0}.phase li{margin:8px 0}@media(max-width:760px){body{padding:16px}.phaseHead{display:block}}
</style>
</head>
<body>
<main class="wrap">
