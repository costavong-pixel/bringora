...
<style>
body{font-family:Arial,sans-serif;background:#f5f7fb;color:#111827;margin:0;padding:28px}.wrap{max-width:900px;margin:auto}.card{background:#fff;padding:24px;border-radius:18px;box-shadow:0 8px 30px rgba(0,0,0,.08);margin-bottom:18px}.ok{color:#166534;font-weight:bold}.warn{color:#92400e;font-weight:bold}.bad{color:#b91c1c;font-weight:bold}.row{display:grid;grid-template-columns:220px 1fr;gap:12px;border-bottom:1px solid #e5e7eb;padding:12px 0}.row:last-child{border-bottom:0}.label{font-weight:bold}.small{font-size:14px;color:#64748b;line-height:1.5}.links a{margin-right:12px}@media(max-width:700px){body{padding:16px}.row{grid-template-columns:1fr}.links a{display:block;margin:8px 0}}
</style>
</head>
<body>
<main class="wrap">
...
<a href="brain.php">My Bringora Brain</a>
