...
<h2>Next action</h2>
<?php if ($websiteReady): ?>
<p class="small">Website/product pages are safe to review. If Generate is still failing, open API Debug next.</p>
<a class="btn" href="api-debug.php">Open API Debug</a><a class="btn ghost" href="index.php">Open App</a>
<?php else: ?>
