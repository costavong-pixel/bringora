...
<h2>Next action</h2>
<?php if ($websiteReady): ?>
<p class="small">Website/product pages are safe to review. If Generate is still failing, follow this path: API Debug → Provider Test → App Generate.</p>
<a class="btn" href="api-debug.php">1. API Debug</a><a class="btn dark" href="provider-test.php">2. Provider Test</a><a class="btn ghost" href="index.php">3. Open App</a>
<?php else: ?>
